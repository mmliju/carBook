...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
         ...
         <div class="col-lg-4">
            <h1 class="page-header">Slot Status</h1>
             <div class="panel panel-default">
                        <div class="panel-heading">
                            Slots
                        </div>
					...
					?>
						...
						<td><span class="label <?php if($val['status'] == 'Active'){ echo 'label-danger';  }else{ echo 'label-success';} ?>"><a href="home.php?slot=<?php echo $val['slot_id']; ?>" ><?php if($val['status'] == 'Active'){ echo 'Disable';  }else{ echo 'Enable';} ?></a></span></td>
					      </tr> 
					<?php
					$i++;
					}
